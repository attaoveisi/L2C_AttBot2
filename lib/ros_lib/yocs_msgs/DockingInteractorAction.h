...
namespace yocs_msgs
{
  ...
  class DockingInteractorAction : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "yocs_msgs/DockingInteractorAction"; };
    virtual const char * getMD5() override { return "fb33b77bf3a235c893241fe6926c99eb"; };
