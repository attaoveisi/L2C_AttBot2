...
namespace yocs_msgs
{
  ...
  class NavigateToActionFeedback : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "yocs_msgs/NavigateToActionFeedback"; };
    virtual const char * getMD5() override { return "7d846f575816c69a71f167110b82fcca"; };
