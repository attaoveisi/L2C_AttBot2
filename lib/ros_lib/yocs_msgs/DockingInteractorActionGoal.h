...
namespace yocs_msgs
{
  ...
  class DockingInteractorActionGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "yocs_msgs/DockingInteractorActionGoal"; };
    virtual const char * getMD5() override { return "c5820befe28db119fe6fe4a6c9e700c9"; };
