...
namespace yocs_msgs
{
  ...
  class NavigationControlStatus : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "yocs_msgs/NavigationControlStatus"; };
    virtual const char * getMD5() override { return "f97c2c5903b273dd04cfb815fadb9f56"; };
