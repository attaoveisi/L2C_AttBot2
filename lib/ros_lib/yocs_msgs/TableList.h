...
namespace yocs_msgs
{
  ...
  class TableList : public ros::Msg
  {
    ...
    TableList():
      tables_length(0), st_tables(), tables(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "yocs_msgs/TableList"; };
    virtual const char * getMD5() override { return "88fff7e2df98bd37f03f85cffc55624b"; };
