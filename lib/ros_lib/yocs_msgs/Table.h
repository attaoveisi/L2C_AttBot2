#ifndef _ROS_yocs_msgs_Table_h
#define _ROS_yocs_msgs_Table_h
...
namespace yocs_msgs
{
  ...
  class Table : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "yocs_msgs/Table"; };
    virtual const char * getMD5() override { return "8e1bb2c627c92d4c6f6075fe37858727"; };
