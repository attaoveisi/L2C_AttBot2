...
namespace kobuki_msgs
{
  ...
  class AutoDockingActionFeedback : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "kobuki_msgs/AutoDockingActionFeedback"; };
    virtual const char * getMD5() override { return "6f7132467beab5153587d9ebb8d8262d"; };
