...
namespace yocs_msgs
{
  ...
  class NavigationControl : public ros::Msg
  {
    public:
      ...
      typedef const char* _goal_name_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 0) = (u_control.base >> (8 * 0)) & 0xFF;
      ...
      varToArr(outbuffer + offset, length_goal_name);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      arrToVar(length_goal_name, (inbuffer + offset));
      offset += 4;
    ...
    virtual const char * getType() override { return "yocs_msgs/NavigationControl"; };
    virtual const char * getMD5() override { return "f2ddf02b376d1d00aed5addfb5cfe0ba"; };
