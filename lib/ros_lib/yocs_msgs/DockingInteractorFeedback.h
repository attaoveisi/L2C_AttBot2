...
namespace yocs_msgs
{
  ...
  class DockingInteractorFeedback : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "yocs_msgs/DockingInteractorFeedback"; };
    virtual const char * getMD5() override { return "b042f523c61fe97bdf0d4da2f2289c63"; };
